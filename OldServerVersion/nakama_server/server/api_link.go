...
func (s *ApiServer) LinkApple(ctx context.Context, in *api.AccountApple) (*emptypb.Empty, error) {
	...
	err := LinkApple(ctx, s.logger, s.db.Hugh_db, s.config, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkCustom(ctx context.Context, in *api.AccountCustom) (*emptypb.Empty, error) {
	...
	err := LinkCustom(ctx, s.logger, s.db.Hugh_db, userID, in.Id)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkDevice(ctx context.Context, in *api.AccountDevice) (*emptypb.Empty, error) {
	...
	err := LinkDevice(ctx, s.logger, s.db.Hugh_db, userID, in.Id)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkEmail(ctx context.Context, in *api.AccountEmail) (*emptypb.Empty, error) {
	...
	err := LinkEmail(ctx, s.logger, s.db.Hugh_db, userID, in.Email, in.Password)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkFacebookInstantGame(ctx context.Context, in *api.AccountFacebookInstantGame) (*emptypb.Empty, error) {
	...
	err := LinkFacebookInstantGame(ctx, s.logger, s.db.Hugh_db, s.config, s.socialClient, userID, in.SignedPlayerInfo)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkGameCenter(ctx context.Context, in *api.AccountGameCenter) (*emptypb.Empty, error) {
	...
	err := LinkGameCenter(ctx, s.logger, s.db.Hugh_db, s.socialClient, userID, in.PlayerId, in.BundleId, in.TimestampSeconds, in.Salt, in.Signature, in.PublicKeyUrl)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkGoogle(ctx context.Context, in *api.AccountGoogle) (*emptypb.Empty, error) {
	...
	err := LinkGoogle(ctx, s.logger, s.db.Hugh_db, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
