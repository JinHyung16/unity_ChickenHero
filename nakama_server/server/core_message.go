...
func ChannelMessageSend(ctx context.Context, logger *zap.Logger, db *runtime.DBManager, router MessageRouter, channelStream PresenceStream, channelId, content, senderId, senderUsername string, persist bool) (*rtapi.ChannelMessageAck, error) {
