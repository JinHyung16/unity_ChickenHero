...
func importSteamFriends(ctx context.Context, logger *zap.Logger, db *runtime.DBManager, messageRouter MessageRouter, client *social.Client, userID uuid.UUID, username, publisherKey, steamId string, reset bool) error {
...
func importFacebookFriends(ctx context.Context, logger *zap.Logger, db *runtime.DBManager, messageRouter MessageRouter, client *social.Client, userID uuid.UUID, username, token string, reset bool) error {
	logger = logger.With(zap.String("userID", userID.String()))
...
func sendFriendAddedNotification(ctx context.Context, logger *zap.Logger, db *runtime.DBManager, messageRouter MessageRouter, userID uuid.UUID, username string, friendUserIDs []uuid.UUID) {
