...
func NotificationSave(ctx context.Context, logger *zap.Logger, db *runtime.DBManager, notifications map[uuid.UUID][]*api.Notification) error {
	...
	if _, err := db.Hugh_db.ExecContext(ctx, query, params...); err != nil {
