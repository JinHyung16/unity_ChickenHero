...
{
    //protected new string Host = "localhost"; //@local host 
    protected new string Host = "35.197.17.99";
    ...
    {
#if UNITY_EDITOR
        Debug.LogFormat("<color=orange><b>[Login-Server]</b> ConnectToLoginServer(DeviceLogin) : Host : {0}, Port : {1} </color>", this.Host, this.Port);
#endif
