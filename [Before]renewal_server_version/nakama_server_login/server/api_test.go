...
func NewAPIServer(t *testing.T, runtime *Runtime) (*ApiServer, *Pipeline) {
	...
	apiServer := StartApiServer(logger, logger, db, protojsonMarshaler, protojsonUnmarshaler, cfg, nil, nil, nil, nil, nil, nil, tracker, router, nil, metrics, pipeline, runtime)
